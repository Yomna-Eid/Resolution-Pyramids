...
#getwd()
this.dir <- "./Results/Imperviousness"
setwd(this.dir)
```  
...
```{r}
r <- read_stars("./2006/impervious2006_20m.tif", na.rm = TRUE) |> setNames("IMP2006") %>% st_as_stars() %>% na.omit()
#r <- read_stars("./2009/impervious2009_20m.tif", na.rm = TRUE) |> setNames("IMP2009") %>% st_as_stars() %>% na.omit()
#r <- read_stars("./2012/impervious2012_20m.tif", na.rm = TRUE) |> setNames("IMP2012") %>% st_as_stars() %>% na.omit()
#r <- read_stars("./2015/impervious2015_20m.tif", na.rm = TRUE) |> setNames("IMP2015") %>% st_as_stars() %>% na.omit()
#r <- read_stars("./2018/impervious2018_20m.tif", na.rm = TRUE) |> setNames("IMP2018") %>% st_as_stars() %>% na.omit()
```

Get Münster, Germany administrative boundaries and crop raster to its bounding-box, then plot:
...
To test the implementation of the method, use a pure nugget effect variogram model:
...
Now compute the mean block-block covariance value using Gauss Quadrature for the raster image (i.e. 2-dimensional grid):
